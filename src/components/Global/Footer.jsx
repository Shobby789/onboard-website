  ...
  return (
    <footer className="w-full  h-screen text-white bg-red-800 flex items-start flex-wrap">
      <div className="flex items-center justify-center horizontal-padding w-full xl:w-[60%] xl:h-full">
        <Link
          to="/contact-us"
          className="text-4xl lg:text-5xl xl:text-7xl 2xl:text-[110px] text-center font-semibold uppercase tracking-wide text-white flex justify-center items-center gap-6 group bebas-nue-font"
        >
          Let's Chat{" "}
