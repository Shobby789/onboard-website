  ...
  return (
    <section className="w-full horizontal-padding h-auto py-12 xl:py-24 2xl:py-40 flex flex-col gap-14 2xl:gap-24 relative">
      <div className="flex flex-col gap-y-6 items-center text-center justify-center px-0 col-span-2 lg:col-span-1">
        <h1 className="text-4xl lg:text-5xl xl:text-7xl 2xl:text-[108px] text-center font-semibold mx-0 px-0 uppercase tracking-tighter text-black">
          Enjoy One Month <br /> Free Trial!
        </h1>
        <p className="text-base px-2 lg:text-xl 2xl:text-2xl font-normal tracking-normal xl:leading-9 text-black lg:w-[50%]">
